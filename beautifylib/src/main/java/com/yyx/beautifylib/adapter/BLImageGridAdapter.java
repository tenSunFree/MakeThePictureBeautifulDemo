...
public class BLImageGridAdapter extends BaseAdapter {
    ...
    public int MAX_SELECT_SIZE = 1;//最大选择数量
...
//        mSelectedImages.clear();
    ...
    public ImageInfo getItem(int position) {
        ...
        // if (showCamera) {
        //     if (position == 0) {
        //         Log.v("more", "getItem(), if (position == 0)");
        //         return null;
        //     }
        //     return mImages.get(position - 1);
        // } else {
        //     Log.v("more", "getItem(), return mImages.get(position)");
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (type == TYPE_CAMERA) {
            Log.v("more", "if (type == TYPE_CAMERA): ");
            ...
            holder.ivCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Toast.makeText(mContext, "holder.ivCheck.setOnClickListener(new View.OnClickListener()", Toast.LENGTH_SHORT).show();
    ...
    class ViewHolder {
        ...
        public void bindData(final ImageInfo data) {
            ...
            if (mSelectedImages.contains(data)) {
                // 设置选中状态
                // Toast.makeText(mContext, "设置选中状态", Toast.LENGTH_SHORT).show();
                ivCheck.setSelected(true);
                // mask.setVisibility(View.GONE);
            } else {
                // 未选择
                // Toast.makeText(mContext, "未选择", Toast.LENGTH_SHORT).show();
