...
public class FilterUtils {
	...
	public static ArrayList<Filter_Effect_Info> getEffectList(){
		...
		effect_list.add(new Filter_Effect_Info("原圖", R.drawable.camerasdk_filter_normal,null));
		effect_list.add(new Filter_Effect_Info("創新", R.drawable.camerasdk_filter_in1977, FilterType.I_1977));
		...
		effect_list.add(new Filter_Effect_Info("優格", R.drawable.camerasdk_filter_hefe, FilterType.I_HEFE));
		effect_list.add(new Filter_Effect_Info("膠片", R.drawable.camerasdk_filter_hudson, FilterType.I_HUDSON));
		effect_list.add(new Filter_Effect_Info("黑白", R.drawable.camerasdk_filter_inkwell, FilterType.I_INKWELL));
		effect_list.add(new Filter_Effect_Info("個性", R.drawable.camerasdk_filter_lomo, FilterType.I_LOMO));
		effect_list.add(new Filter_Effect_Info("回憶", R.drawable.camerasdk_filter_lord_kelvin, FilterType.I_LORDKELVIN));
		effect_list.add(new Filter_Effect_Info("不羈", R.drawable.camerasdk_filter_nashville, FilterType.I_NASHVILLE));
		...
		effect_list.add(new Filter_Effect_Info("絢麗", R.drawable.camerasdk_filter_toaster, FilterType.I_TOASTER));
		effect_list.add(new Filter_Effect_Info("優雅", R.drawable.camerasdk_filter_valencia, FilterType.I_VALENCIA));
